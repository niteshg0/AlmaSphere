  ...
  return (
      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl shadow-2xl rounded-3xl overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border border-gray-200 dark:border-gray-700">
        ...
        <div className="md:w-1/2 p-8 flex flex-col justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-indigo-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
          <h2 className="text-4xl font-extrabold mb-4 text-gray-900 dark:text-white">Get in Touch</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <span className="text-blue-600 dark:text-blue-400">
                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" className="inline-block"><path d="M21 10.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h7.5"></path><path d="M16 21l5-5"></path><path d="M21 21v-4.8a2 2 0 0 0-2-2h-4.8"></path></svg>
              </span>
              <span className="text-gray-800 dark:text-gray-200">alumni@college.edu</span>
            </div>
            <div className="flex items-center space-x-3">
              <span className="text-blue-600 dark:text-blue-400">
                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" className="inline-block"><path d="M17 10.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h7.5"></path><path d="M16 21l5-5"></path><path d="M21 21v-4.8a2 2 0 0 0-2-2h-4.8"></path></svg>
              </span>
              <span className="text-gray-800 dark:text-gray-200">+91 12345 67890</span>
            </div>
            <div className="flex items-center space-x-3">
              <span className="text-blue-600 dark:text-blue-400">
                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" className="inline-block"><path d="M21 10.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h7.5"></path><path d="M16 21l5-5"></path><path d="M21 21v-4.8a2 2 0 0 0-2-2h-4.8"></path></svg>
              </span>
              <span className="text-gray-800 dark:text-gray-200">123 College Road, City, Country</span>
            </div>
          </div>
          <div className="mt-8 hidden md:block">
            <img src="/undraw_mailbox_e7nc.svg"
        ...
        {/* Right: Form */}
         <div className="md:w-1/2 p-8 flex flex-col justify-center">
           <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
             <div>
               <label className="block text-gray-700 dark:text-gray-200 mb-2 font-semibold" htmlFor="name">
                 Name
               </label>
               <input
            ...
            <div>
              <label className="block text-gray-700 dark:text-gray-200 mb-2 font-semibold" htmlFor="message">
                Message
              </label>
              <textarea
                className={`w-full px-4 py-2 border rounded-lg bg-white/70 dark:bg-gray-900/70 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition ${
              ...
              />
              {errors.message && (
                <p className="text-red-600 dark:text-red-400 text-sm mt-1">{errors.message.message}</p>
              )}
            </div>
            <button
              type="submit"
