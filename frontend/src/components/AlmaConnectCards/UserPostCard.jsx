          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {post.tags?.map((tag, index) => (
                <span
                  key={index}
                  className="px-3 py-1 bg-white/30 dark:bg-black/30 text-gray-700 dark:text-gray-300 text-sm rounded-full backdrop-blur-sm border border-gray-300/40 dark:border-gray-700/40"
                >
                  ✓ {tag}
                </span>
              ))}
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="aspect-video bg-white/20 dark:bg-black/20 rounded-2xl border border-gray-300/40 dark:border-gray-700/40 flex items-center justify-center backdrop-blur-sm">
                ...
                <img
                  ...
                  className="bg-contain w-52"
                />
              </div>
              <div className="space-y-2 border rounded-xl border-gray-300/40 dark:border-gray-700/40"></div>
            </div>
          )}
