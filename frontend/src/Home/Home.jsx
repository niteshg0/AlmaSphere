    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1
            className={`text-4xl md:text-6xl lg:text-7xl font-bold font-serif mb-8 bg-clip-text text-transparent leading-tight ${
              isDarkTheme
          ...
          <p
            className={`text-lg md:text-xl lg:text-2xl font-serif mb-12 ${
            ...
            <button
              ...
              className={`px-8 py-3 rounded-full font-medium transition-all duration-300 transform hover:scale-105 ${
                isDarkTheme
                  ...
                  : "bg-white hover:bg-gray-50 text-indigo-900 border border-indigo-200"
              }`}
            >
              Explore Benefits
            </button>
      ...
      <section id="card-section" className="container mx-auto py-20 px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2
            className={`text-4xl md:text-5xl font-bold mb-6 font-sans ${
              isDarkTheme ? "text-indigo-400" : "text-indigo-900"
            }`}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Event Card */}
          <div
            className={`group relative p-8 rounded-3xl overflow-hidden transition-all duration-500 h-[280px] flex flex-col ${
              isDarkTheme
          ...
          <Link to="/jobs" className="block h-[280px]">
            <div
              className={`group relative p-8 rounded-3xl overflow-hidden transition-all duration-500 h-full flex flex-col ${
                isDarkTheme
                  ? "bg-gradient-to-br from-gray-800/90 to-gray-900/90"
                  : "bg-gradient-to-br from-white/90 to-gray-50/90"
              }`}
