...
function AddStudent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Add new students individually or upload in bulk via Excel
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              <ExcelUpload setDuplicateData={setDuplicateData} setErrorData= {setErrorData} />

              {/* Instructions Panel */}
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                <h3 className="text-lg font-semibold text-indigo-900 dark:text-indigo-400 mb-4">
                  Instructions
                </h3>
                <div className="prose dark:prose-invert max-w-none">
                  <ul className="list-disc list-inside space-y-2 text-sm text-gray-600 dark:text-gray-400">
                    <li>Use the form to add individual students</li>
                    <li>For bulk uploads, use the Excel upload option</li>
                    <li>Ensure all required fields are filled correctly</li>
                    <li>CGPA should be between 0 and 10 and upto 2 decimal places</li>
                    <li>Roll numbers must be of minimum 10 digits and maximum 15 digit</li>
                    <li>Batch format should be YYYY-YYYY</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      {/* Show tables only if there's data */}
        {(duplicateData?.length > 0 || errorData?.length > 0) && (
          <div className="space-y-6">
            {duplicateData?.length > 0 && (
              <Table title="Duplicate Entries" college_data={duplicateData} />
            )}

            {errorData?.length > 0 && (
              <Table title="Incorrect Format Entries" college_data={errorData} />
            )}
          </div>
        )}
    </div>
